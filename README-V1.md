...
> **Ce document décrit la V1**, celle qui sert des clients en production sur la
> branche `main` et produit du HTML, du CSS et du JS. Ses commandes restent
> disponibles ici.
>
> La V2 est documentée dans le [`README.md`](README.md) de ce dépôt.
